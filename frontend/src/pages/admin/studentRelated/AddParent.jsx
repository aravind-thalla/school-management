...
const AddParent = ({ situation }) => {
    ...
    const fields = { name, email, password, childName, childRollNum, sclassName, adminID, role }
        ...
        <>
            <div className="register">
                <form className="registerForm" onSubmit={submitHandler}>
                    ...
                    <input className="registerInput" type="text" placeholder="Enter child's name..."
                        value={childName}
                        onChange={(event) => setChildName(event.target.value)}
                        required />

                    <label>Child's Roll Number</label>
                    <input className="registerInput" type="number" placeholder="Enter child's roll number..."
                        value={childRollNum}
                        onChange={(event) => setChildRollNum(event.target.value)}
                        required />
