...
const ViewStudent = () => {
    ...
    const [childRollNum, setChildRollNum] = useState('');
    ...
    const fields = password === ""
        ? { name, childRollNum }
        : { name, childRollNum, password }

    useEffect(() => {
        if (userDetails) {
            setName(userDetails.name || '');
            setChildRollNum(userDetails.childRollNum || '');
    ...
    const removeSubAttendance = (subId) => {
        dispatch(updateStudentFields(studentID, { subId }, "RemoveParentSubAtten"))
            .then(() => {
                dispatch(getUserDetails(studentID, address));
            })
    }
        ...
        const renderTableSection = () => {
            return (
                <>
                    ...
                    <Button variant="contained" color="error" startIcon={<DeleteIcon />} onClick={() => removeHandler(studentID, "RemoveParentAtten")}>Delete All</Button>
    ...
    const StudentDetailsSection = () => {
        return (
            <div>
                ...
                <br />
                Roll Number: {userDetails.childRollNum}
                <br />
